...
H_0 = - Delta * n_a - g_o * a.dag() * a * (b.dag() + b) + n_b + E_J / 2 * sz + g_q * (b.dag() + b) * sx + 1j * A_lp * (a.dag() - a)
...
if __name__=='__main__':
    ...
    np.savez_compressed('data/v3.2_qutip-v4.7.3/qubit_optomech_basis_ntraj={}_N={}_Omega={}_t_mul={}_t_ssz={}_irr.npz'.format(ntraj, N, Omega, t_mul, t_ssz), np.array(arr)[:, ::t_ssz])